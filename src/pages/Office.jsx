...
export default function Office() {
  useDocumentTitle("Office Collection");
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          <div className="animate-in slide-in-from-bottom-4 duration-1000 delay-100">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 text-white drop-shadow-xl">
              {viewMode === "all" ? "All Products" : "Office"}
            </h1>
            <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
              Explore our exclusive collection of high-quality office essentials
              designed for productivity and professional style.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <DropdownMenu>
                    ...
                    >
                      ...
                      <DropdownMenuItem
                        ...
                        className={`cursor-pointer ${viewMode === "office" && sortBy === "default" ? "bg-primary/10 text-primary font-bold" : "font-medium"}`}
                      >
                        Featured
                      </DropdownMenuItem>
                      <DropdownMenuItem
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-muted/20 rounded-2xl border border-border/50 animate-in zoom-in-95 duration-700">
                ...
                <p className="text-muted-foreground">
                  We couldn't find any office products right now.
                </p>
              </div>
            )}
          </div>
