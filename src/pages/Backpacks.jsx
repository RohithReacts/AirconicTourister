...
import bannerImage from "@/assets/banner1.webp"; // Using banner1.webp as a placeholder, can change if needed
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const backpacksProducts = allProducts.filter(
          (p) => p.category?.toLowerCase() === "backpacks",
        );
    ...
    <div className="animate-in fade-in duration-500 w-full mb-12">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          <div className="animate-in slide-in-from-bottom-4 duration-1000 delay-100">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 text-white drop-shadow-xl">
              {viewMode === "all" ? "All Products" : "Backpacks"}
            </h1>
            <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
              Explore our exclusive collection of high-quality backpacks
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8 overflow-x-auto whitespace-nowrap pb-2 mt-2">
          ...
          <ChevronRight className="w-4 h-4 text-muted-foreground/50" />
          <span className="text-foreground font-semibold">Backpacks</span>
        </nav>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <DropdownMenu>
                    ...
                    >
                      ...
                      <DropdownMenuItem
                        onClick={() => {
                          setViewMode("backpacks");
                          setSortBy("default");
                        }}
                        className={`cursor-pointer ${viewMode === "backpacks" && sortBy === "default" ? "bg-primary/10 text-primary font-bold" : "font-medium"}`}
                      >
                        Featured
                      </DropdownMenuItem>
                      <DropdownMenuItem
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-muted/20 rounded-2xl border border-border/50 animate-in zoom-in-95 duration-700">
                ...
                <p className="text-muted-foreground">
                  We couldn't find any backpacks in this category right now.
                </p>
              </div>
            )}
          </div>
